  ...
  (
    ...
    const editor = useEditor({
      extensions: [
        ...
        Link.configure({
          openOnClick: false, // Links won't open on click
          autolink: true, // Automatically detect links
          linkOnPaste: true, // Preserve links when pasting content
        }).extend({
          inclusive: false,
    ...
    return (
      ...
      >
        ...
        >
          <EditorContent
            editor={editor}
            className={cn("p-5 prose-link:underline prose-link:text-blue-600", contentClass)}
            style={{ color: "black" }}
          />
        </div>
      </div>
